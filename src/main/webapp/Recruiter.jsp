...
<div class="topnav" id="myTopnav">
  ...
  <a style="color: DarkOrange;font-size: 20px;" href="PostJob.jsp">Post Job</a>
  <a style="color: DarkOrange;font-size: 20px;" href="ViewApplicant.jsp">View Applicant</a>
  <a style="color: DarkOrange;font-size: 20px;" href="UpdateApplicantStatus.jsp">Add Applicant Status</a>
  <a style="color: DarkOrange;font-size: 20px;" href="AppliedJobStatus.jsp">View Status</a>
  <a style="color: DarkOrange;font-size: 20px;" href="RecruiterViewPostJobs.jsp?postId=0">View Post Jobs</a>
...
<div class="slideshow-container">
    ...
    <div class="mySlides fade" style="display: none;">
      ...
      <img src="Assets/1.jpg" style="width:100%;height: 430px;">
      <div class="text"></div>
    </div>
    ...
    <div class="mySlides fade" style="display: block;">
      <div class="numbertext"></div>
      <img src="Assets/8.jpg" style="width:100%;height: 430px;">
      <div class="text"></div>
    </div>
